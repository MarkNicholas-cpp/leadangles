  ...
  return (
    <div className="">
      <div className="py-24 flex items-center justify-center">
        <div className=" text-primary flex items-center justify-center flex-col px-10">
          <p className="text-4xl md:text-7xl md:w-3/4 text-center">
            Get Paid Memberships with flexible plans and features
          </p>
          <p className="text-sm  md:w-1/2 text-primary/60 text-center">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 mb-10 00">
